        ...
        return (
            <div className={classes.Home}>
                ...
                <section className={classes.Section}>
                    <h3>About</h3>
                    <p>
                        Hi there! I'm George, a frontend developer with an MSc
                        in Computer Science at the University of Birmingham. I
                ...
                <section className={classes.Section}>
                    <h3>Strengths</h3>
                    <p>
                        I have experience with front and back end technologies,
                ...
                <section className={classes.Section}>
                    <h3>Hobbies</h3>
                    <p>
                        When I am not writing code, you're most likely to find
                    ...
                    <ul>
                        <li>
                            ...
                            <p>
                                Currently, I'm 4 years into Mandarin Chinese and
                                10 years into Spanish.
                            </p>
                            <p>
                        ...
                        <li>
                            <h3>Playing music</h3>
                            <p>
                                I've been playing classical/folk music on the
                                acoustic guitar and jazz/blues on the piano from
                                a young age.
                            </p>
                            <p></p>
                        </li>
                        <li>
                            <h3>Drinking tea</h3>
                            <p>
                                I've been fascinated by traditional Chinese tea
                                culture for several years now, I even have a
                                tasting blog{" "}
                                <a href="https://leafandliquor.wordpress.com/">
                                    here
                                </a>
                                .
                            </p>
